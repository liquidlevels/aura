...
// import { View, Text, TextInput, Modal, Button, TouchableOpacity, FlatList, KeyboardAvoidingView, Platform, TouchableWithoutFeedback, Keyboard } from "react-native";
...
//     if (nota.trim()) {
//       try {
//         const respuesta = await api.post("API_URL/notes", {
//           nota,
//           patient_id: user?.id,
//         });
...
//         } else {
//           alert("Hubo un problema al agregar la nota.");
//         }
//       } catch (error) {
